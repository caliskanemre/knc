...
export const productReviews = {
  ...
  "17": [
    ...
    "70": [ // Hasır Detaylı Bohem Nedime Defi
        {
            username: "Selin C.",
            rating: 5,
    ...
    "30": [ // İşlemeli "Gelin" Yazılı Halay Mendili
        {
            username: "Fatma Nur Ş.",
            rating: 5,
            comment: "İşlemesi o kadar zarif ki... Kendi ismimi yazdırmadım ama yazılı olmayan bile harika duruyor. Kumaşı da kaliteli.",
            date: "2025-09-22",
            source: { tr: "Trendyol yorumu", en: "Trendyol review" }
        }
    ],

    "35": [ // Geleneksel Kırmızı Kına Seti
        {
            username: "Denise O.",
            rating: 5,
    ...
    "28": [ // Kişiye Özel İsimli El İşi Pullu Halay Mendili
        {
            username: "Sıla T.",
            rating: 5,
