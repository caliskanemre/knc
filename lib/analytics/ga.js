...
export const GA_MEASUREMENT_ID = process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID || 'G-41P0XLVW05';

let lastTrackedPath = null;
let lastTrackedTime = 0;

export function initGA(measurementId = GA_MEASUREMENT_ID, adsConversionId) {
